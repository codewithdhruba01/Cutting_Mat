  ...
  return (
    <div className="space-y-4 pt-2">
      <div className="flex items-center justify-between">
        ...
        <Switch checked={grid.enabled} onCheckedChange={(val) => handleChange("enabled", val)} />
      </div>
        ...
        <>
          ...
          <div className="space-y-3 pt-2">
            ...
            <Slider
              ...
              onValueChange={(val: readonly number[] | number) =>
                handleChange("opacity", Array.isArray(val) ? val[0] : val)
              }
              min={0}
              max={1}
              step={0.01}
          ...
          <div className="space-y-3 pt-2">
            ...
            <Slider
              ...
              onValueChange={(val: readonly number[] | number) =>
                handleChange("majorThickness", Array.isArray(val) ? val[0] : val)
              }
              min={0.1}
              max={10}
              step={0.1}
          ...
          <div className="space-y-3 pt-2">
            ...
            <Slider
              ...
              onValueChange={(val: readonly number[] | number) =>
                handleChange("minorThickness", Array.isArray(val) ? val[0] : val)
              }
              min={0.1}
              max={10}
              step={0.1}
