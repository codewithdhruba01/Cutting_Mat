        ...
        <>
          <div className="grid grid-cols-2 gap-2">
            <Label className="flex items-center gap-2 text-sm">
              <Switch
                checked={numericGuides.top}
                onCheckedChange={(val) => handleChange("top", val)}
              />{" "}
              Top
            </Label>
            <Label className="flex items-center gap-2 text-sm">
              <Switch
                checked={numericGuides.bottom}
                onCheckedChange={(val) => handleChange("bottom", val)}
              />{" "}
              Bottom
            </Label>
            <Label className="flex items-center gap-2 text-sm">
              <Switch
                checked={numericGuides.left}
                onCheckedChange={(val) => handleChange("left", val)}
              />{" "}
              Left
            </Label>
            <Label className="flex items-center gap-2 text-sm">
              <Switch
                checked={numericGuides.right}
                onCheckedChange={(val) => handleChange("right", val)}
              />{" "}
              Right
            </Label>
          </div>
  ...
  return (
    <div className="space-y-4 pt-2">
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={settings.radiusGuides.enabled}
          onCheckedChange={(val) =>
            updateSettings((p) => ({ ...p, radiusGuides: { ...p.radiusGuides, enabled: val } }))
          }
        />
      </div>
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={settings.angleGuides.enabled}
          onCheckedChange={(val) =>
            updateSettings((p) => ({ ...p, angleGuides: { ...p.angleGuides, enabled: val } }))
          }
        />
      </div>
      <div className="flex items-center justify-between">
        ...
        <Switch
          checked={settings.diagonalGuides.enabled}
          onCheckedChange={(val) =>
            updateSettings((p) => ({ ...p, diagonalGuides: { ...p.diagonalGuides, enabled: val } }))
          }
        />
      </div>
      <div className="flex items-center justify-between">
        ...
        <Switch
          ...
          onCheckedChange={(val) =>
            updateSettings((p) => ({ ...p, crosshair: { ...p.crosshair, enabled: val } }))
          }
        />
      </div>
    </div>
